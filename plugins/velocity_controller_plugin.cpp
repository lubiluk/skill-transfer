...
public:
  ...
  void Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf)
  {
    ...
    // else
    // {
      this->linear_P_ = 100.0;
      this->linear_I_ = 0.0;
      this->linear_D_ = 25.0;
      this->angular_P_ = 0.001;
      this->angular_I_ = 0.0;
      this->angular_D_ = 0.0002;

    //   gzdbg << "Using default PID gains\n";
    // }
    ...
    this->pid_angular_x_ = common::PID(angular_P_, angular_I_, angular_D_, 0.001, -0.001);
    this->pid_angular_y_ = common::PID(angular_P_, angular_I_, angular_D_, 0.001, -0.001);
    this->pid_angular_z_ = common::PID(angular_P_, angular_I_, angular_D_, 0.001, -0.001);
  }
  ...
  void UpdateObjectForces(const common::Time _delta_time)
  {
    ...
    this->link_->SetAngularVel(math::Vector3{this->desired_twist_.angular.x, this->desired_twist_.angular.y, this->desired_twist_.angular.z});
  }
